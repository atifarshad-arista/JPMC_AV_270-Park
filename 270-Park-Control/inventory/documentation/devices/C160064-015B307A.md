...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.142.182/28 | 10.176.142.177 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MAP_15TRC_001_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet2 | MAP_15TRC_002_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet3 | MAP_15TRC_003_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet4 | MAP_15TRC_004_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet5 | CAM_15LFD_001_Panasonic_AW_UE_160WP_Port_1 | access | 107 | - | - | - |
| Ethernet6 | CAM_15LFD_002_Panasonic_AW_UE_160WP_Port_1 | access | 107 | - | - | - |
| Ethernet7 | CAM_15LFD_003_Panasonic_AW_UE_160WP_Port_1 | access | 107 | - | - | - |
| Ethernet8 | CAM_15LFD_004_Panasonic_AW_UE_160WP_Port_1 | access | 107 | - | - | - |
| Ethernet9 | CAM_15LFD_005_Panasonic_AW_UE_160WP_Port_1 | access | 107 | - | - | - |
| Ethernet10 | MIC_15LFD_001_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet11 | MIC_15LFD_002_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet12 | MIC_15LFD_003_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet13 | MIC_15LFD_004_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet14 | MIC_15LFD_005_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet15 | MIC_15LFD_006_SENNHEISER_TCC2_Port_2 | access | 314 | - | - | - |
| Ethernet16 | WAP_15LFD_001_TELEVIC_CONFIDEA_WAP_G4_D_Port_1 | access | 313 | - | - | - |
| Ethernet17 | WAP_15LFD_001_TELEVIC_CONFIDEA_WAP_G4_D_Port_2 | access | 100 | - | - | - |
| Ethernet18 | SLD_15LFD_001_INTERSPACE_i2NET_RF_RX_Port_1 | access | 100 | - | - | - |
| Ethernet19 | SLD_15LFD_002_INTERSPACE_i2NET_RF_RX_Port_1 | access | 100 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet8/18/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet8/18/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
!
interface Ethernet1
   description MAP_15TRC_001_SHURE_AD610_Port_1
   no shutdown
...
!
interface Ethernet2
   description MAP_15TRC_002_SHURE_AD610_Port_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
!
interface Ethernet3
   description MAP_15TRC_003_SHURE_AD610_Port_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
!
interface Ethernet4
   description MAP_15TRC_004_SHURE_AD610_Port_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
!
interface Ethernet5
   description CAM_15LFD_001_Panasonic_AW_UE_160WP_Port_1
   no shutdown
...
!
interface Ethernet6
   description CAM_15LFD_002_Panasonic_AW_UE_160WP_Port_1
   no shutdown
   switchport access vlan 107
   switchport mode access
   switchport
!
interface Ethernet7
   description CAM_15LFD_003_Panasonic_AW_UE_160WP_Port_1
   no shutdown
   switchport access vlan 107
   switchport mode access
   switchport
!
interface Ethernet8
   description CAM_15LFD_004_Panasonic_AW_UE_160WP_Port_1
   no shutdown
   switchport access vlan 107
   switchport mode access
   switchport
!
interface Ethernet9
   description CAM_15LFD_005_Panasonic_AW_UE_160WP_Port_1
   no shutdown
   switchport access vlan 107
   switchport mode access
   switchport
...
interface Ethernet10
   description MIC_15LFD_001_SENNHEISER_TCC2_Port_2
   no shutdown
...
interface Ethernet11
   description MIC_15LFD_002_SENNHEISER_TCC2_Port_2
   no shutdown
   switchport access vlan 314
   switchport mode access
   switchport
...
interface Ethernet12
   description MIC_15LFD_003_SENNHEISER_TCC2_Port_2
   no shutdown
   switchport access vlan 314
   switchport mode access
   switchport
...
interface Ethernet13
   description MIC_15LFD_004_SENNHEISER_TCC2_Port_2
   no shutdown
   switchport access vlan 314
   switchport mode access
   switchport
...
interface Ethernet14
   description MIC_15LFD_005_SENNHEISER_TCC2_Port_2
   no shutdown
   switchport access vlan 314
   switchport mode access
   switchport
...
interface Ethernet15
   description MIC_15LFD_006_SENNHEISER_TCC2_Port_2
   no shutdown
   switchport access vlan 314
   switchport mode access
   switchport
...
interface Ethernet16
   description WAP_15LFD_001_TELEVIC_CONFIDEA_WAP_G4_D_Port_1
   no shutdown
...
interface Ethernet17
   description WAP_15LFD_001_TELEVIC_CONFIDEA_WAP_G4_D_Port_2
   no shutdown
...
interface Ethernet18
   description SLD_15LFD_001_INTERSPACE_i2NET_RF_RX_Port_1
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet19
   description SLD_15LFD_002_INTERSPACE_i2NET_RF_RX_Port_1
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet8/18/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet8/18/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel112 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.112/24  |  -  |  -  |  -  |  -  |
