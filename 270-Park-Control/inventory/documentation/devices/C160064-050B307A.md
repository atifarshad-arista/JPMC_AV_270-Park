...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.143.85/28 | 10.176.143.81 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DSP_50MMN_003_QSC_CORE_510i_Port_2 | access | 338 | - | - | - |
| Ethernet2 | CMIC_50MMN_001_TELEVIC_Plixus_Port_1 | access | 338 | - | - | - |
| Ethernet3 | DSP_50MMN_001_QSC_CORE_610_Port_2 | access | 338 | - | - | - |
| Ethernet4 | DSP_50MMN_001_QSC_CORE_610_Port_4 | access | 100 | - | - | - |
| Ethernet5 | DSP_50MMN_002_QSC_CORE_610_Port_2 | access | 338 | - | - | - |
| Ethernet6 | ACONV_50MMN_01_DirectOut_PRODIGY.MX_Port_2 | access | 338 | - | - | - |
| Ethernet7 | ACONV_50MMN_01_DirectOut_PRODIGY.MX_Port_4 | access | 338 | - | - | - |
| Ethernet8 | AMP_50MMN_001_QSC_CX_Q_4K8_Port_2 | access | 338 | - | - | - |
| Ethernet9 | DSP_50BGR_001_QSC_Core_8_Flex_Port_2 | access | 304 | - | - | - |
| Ethernet10 | AMP_50BGR_001_QSC_CX_Q_4K8_Port_2 | access | 304 | - | - | - |
| Ethernet11 | AMP_50BGR_002_QSC_CX_Q_4K8_Port_2 | access | 304 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet9/9/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet9/9/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
!
interface Ethernet1
   description DSP_50MMN_003_QSC_CORE_510i_Port_2
   no shutdown
...
!
interface Ethernet3
   description DSP_50MMN_001_QSC_CORE_610_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet4
   description DSP_50MMN_001_QSC_CORE_610_Port_4
   no shutdown
...
!
interface Ethernet5
   description DSP_50MMN_002_QSC_CORE_610_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet6
   description ACONV_50MMN_01_DirectOut_PRODIGY.MX_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet7
   description ACONV_50MMN_01_DirectOut_PRODIGY.MX_Port_4
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet8
   description AMP_50MMN_001_QSC_CX_Q_4K8_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet9
   description DSP_50BGR_001_QSC_Core_8_Flex_Port_2
   no shutdown
...
interface Ethernet10
   description AMP_50BGR_001_QSC_CX_Q_4K8_Port_2
   no shutdown
   switchport access vlan 304
   switchport mode access
   switchport
...
interface Ethernet11
   description AMP_50BGR_002_QSC_CX_Q_4K8_Port_2
   no shutdown
   switchport access vlan 304
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet9/9/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet9/9/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel183 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.183/24  |  -  |  -  |  -  |  -  |
