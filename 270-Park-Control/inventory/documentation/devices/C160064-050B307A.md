...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DSP_50MMN_003_Port_2 | access | 338 | - | - | - |
| Ethernet2 | CMIC_50MMN_001_Port_1 | access | 338 | - | - | - |
| Ethernet3 | DSP_50MMN_001_Port_2 | access | 338 | - | - | - |
| Ethernet4 | DSP_50MMN_001_Port_4 | access | 100 | - | - | - |
| Ethernet5 | DSP_50MMN_002_Port_2 | access | 338 | - | - | - |
| Ethernet6 | ACONV_50MMN_01_Port_2 | access | 338 | - | - | - |
| Ethernet7 | ACONV_50MMN_01_Port_4 | access | 338 | - | - | - |
| Ethernet8 | AMP_50MMN_001_Port_2 | access | 338 | - | - | - |
| Ethernet9 | DSP_50BGR_001_Port_2 | access | 304 | - | - | - |
| Ethernet10 | AMP_50BGR_001_Port_2 | access | 304 | - | - | - |
| Ethernet11 | AMP_50BGR_002_Port_2 | access | 304 | - | - | - |
...
!
interface Ethernet1
   description DSP_50MMN_003_Port_2
   no shutdown
...
!
interface Ethernet3
   description DSP_50MMN_001_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet4
   description DSP_50MMN_001_Port_4
   no shutdown
...
!
interface Ethernet5
   description DSP_50MMN_002_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet6
   description ACONV_50MMN_01_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet7
   description ACONV_50MMN_01_Port_4
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet8
   description AMP_50MMN_001_Port_2
   no shutdown
   switchport access vlan 338
   switchport mode access
   switchport
!
interface Ethernet9
   description DSP_50BGR_001_Port_2
   no shutdown
...
interface Ethernet10
   description AMP_50BGR_001_Port_2
   no shutdown
   switchport access vlan 304
   switchport mode access
   switchport
...
interface Ethernet11
   description AMP_50BGR_002_Port_2
   no shutdown
   switchport access vlan 304
   switchport mode access
   switchport
