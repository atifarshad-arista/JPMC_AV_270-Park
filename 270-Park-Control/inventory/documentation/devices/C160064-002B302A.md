...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.136.131/28 | 10.176.136.129 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | GPLB_SPK91_EDC_ACOUSTICS_SS_3_Port_RJ45 | access | 305 | - | - | - |
| Ethernet2 | GPLB_SKP81A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet3 | GPLB_SKP82A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet4 | GPLB_SKP83A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet5 | GPLB_SKP84A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet6 | GPLB_SKP85A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet11 | 02B_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 303 | - | - | - |
| Ethernet21 | 02B_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 304 | - | - | - |
| Ethernet25 | GPLB_SPK91_EDC_ACOUSTICS_SS_3_Port_RJ45 | access | 100 | - | - | - |
| Ethernet26 | 02B_SPK10_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet27 | 02B_SPK13_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet28 | 02B_SPK14_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet29 | 02B_SPK17_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet30 | 02B_SPK18_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet35 | 02E_MED_SVR_A_7th_Sense_R10_Port_RJ45 | access | 261 | - | - | - |
| Ethernet36 | 02E_MED_SVR_B_7th_Sense_R10_Port_RJ45 | access | 261 | - | - | - |
| Ethernet37 | 02E_MED_SVR_C_7th_Sense_R10_Port_RJ45 | access | 261 | - | - | - |
| Ethernet38 | 02E_MED_SVR_D_7th_Sense_R10_Port_RJ45 | access | 261 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet7/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet7/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
!
interface Ethernet1
   description GPLB_SPK91_EDC_ACOUSTICS_SS_3_Port_RJ45
   no shutdown
...
!
interface Ethernet2
   description GPLB_SKP81A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet3
   description GPLB_SKP82A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet4
   description GPLB_SKP83A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet5
   description GPLB_SKP84A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet6
   description GPLB_SKP85A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet11
   description 02B_APROC_A_QSC_Core_8_Flex_Port_RJ45
   no shutdown
...
interface Ethernet26
   description 02B_SPK10_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet27
   description 02B_SPK13_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet28
   description 02B_SPK14_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet29
   description 02B_SPK17_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet30
   description 02B_SPK18_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet7/23/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet7/23/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel73 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
interface Port-Channel10
   description L2_SPINES_Port-Channel73
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.73/24  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.176.136.129 | - | 1 | - | - | - |
...
ip route vrf MGMT 0.0.0.0/0 10.176.136.129
```
