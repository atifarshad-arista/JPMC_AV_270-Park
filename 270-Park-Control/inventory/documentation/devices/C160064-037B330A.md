...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | RTR_37ACRB_453_01_18_Port_PRI | access | 301 | - | - | - |
...
| Ethernet28 | MXR_37CR_1200_01_Port_ETH(POE_IN) | access | 106 | - | - | - |
...
!
interface Ethernet1
   description RTR_37ACRB_453_01_18_Port_PRI
   no shutdown
...
interface Ethernet28
   description MXR_37CR_1200_01_Port_ETH(POE_IN)
   no shutdown
   switchport access vlan 106
   switchport mode access
   switchport
