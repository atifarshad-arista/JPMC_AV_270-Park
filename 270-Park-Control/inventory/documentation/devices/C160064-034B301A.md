...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.140.115/28 | 10.176.140.113 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | US_NY_New_York_270P_Flr_34_34AAT041_DSP_01_QSC_Core_8_Flex_Port_0 | access | 303 | - | - | - |
| Ethernet2 | US_NY_New_York_270P_Flr_34_34AAT041_AMP_01_QSC_CX_Qn_4K8_Port_0 | access | 303 | - | - | - |
| Ethernet3 | US_NY_New_York_270P_Flr_34_34ACC013A_BTP_01_QSC_unD6IO_BT_Port_0 | access | 303 | - | - | - |
| Ethernet4 | US_NY_New_York_270P_Flr_34_34ACC013A_VCP_01_QSC_Axon_C1_Port_0 | access | 303 | - | - | - |
| Ethernet5 | US_NY_New_York_270P_Flr_34_34ACC013B_BTP_01_QSC_unD6IO_BT_Port_0 | access | 303 | - | - | - |
| Ethernet6 | US_NY_New_York_270P_Flr_34_34ACC013B_VCP_01_QSC_Axon_C1_Port_0 | access | 303 | - | - | - |
| Ethernet8 | 34WW_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45 | access | 303 | - | - | - |
| Ethernet9 | 34MW_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45 | access | 303 | - | - | - |
| Ethernet10 | 34WC_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45 | access | 303 | - | - | - |
| Ethernet11 | 34A_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 303 | - | - | - |
| Ethernet21 | 34A_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 304 | - | - | - |
| Ethernet48 | US_NY_New_York_270P_Flr_34_34AAT041_PDU_01_CHATSWORTH_EA_5001_CE_Port_0 | access | 202 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet9/13/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet9/13/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
!
interface Ethernet1
   description US_NY_New_York_270P_Flr_34_34AAT041_DSP_01_QSC_Core_8_Flex_Port_0
   no shutdown
...
!
interface Ethernet2
   description US_NY_New_York_270P_Flr_34_34AAT041_AMP_01_QSC_CX_Qn_4K8_Port_0
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet3
   description US_NY_New_York_270P_Flr_34_34ACC013A_BTP_01_QSC_unD6IO_BT_Port_0
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet4
   description US_NY_New_York_270P_Flr_34_34ACC013A_VCP_01_QSC_Axon_C1_Port_0
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet5
   description US_NY_New_York_270P_Flr_34_34ACC013B_BTP_01_QSC_unD6IO_BT_Port_0
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet6
   description US_NY_New_York_270P_Flr_34_34ACC013B_VCP_01_QSC_Axon_C1_Port_0
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet8
   description 34WW_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
!
interface Ethernet9
   description 34MW_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
...
interface Ethernet10
   description 34WC_SPK_M_Sound_Tube_IPD4_CM62_BGM_II_Port_RJ45
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
...
interface Ethernet11
   description 34A_APROC_A_QSC_Core_8_Flex_Port_RJ45
   no shutdown
   switchport access vlan 303
   switchport mode access
   switchport
...
interface Ethernet48
   description US_NY_New_York_270P_Flr_34_34AAT041_PDU_01_CHATSWORTH_EA_5001_CE_Port_0
   no shutdown
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet9/13/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet9/13/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel151 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.151/24  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.176.140.113 | - | 1 | - | - | - |
...
ip route vrf MGMT 0.0.0.0/0 10.176.140.113
```
