...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.166.80.2/27 | 10.166.80.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MIC_RX_37C02_14_SHURE_ANX4_Port_CTRL_1 | access | 108 | - | - | - |
| Ethernet2 | MIC_RX_37C02_15_SHURE_ANX4_Port_CTRL_1 | access | 108 | - | - | - |
| Ethernet15 | GWAY_37C02_01_01_EVS_NEURON_BRIDGE_Port_CTL | access | 101 | - | - | - |
| Ethernet16 | GWAY_37C02_01_02_EVS_NEURON_BRIDGE_Port_CTL | access | 101 | - | - | - |
| Ethernet17 | GWAY_37C02_02_01_EVS_NEURON_BRIDGE_Port_CTL | access | 101 | - | - | - |
| Ethernet18 | GWAY_37C02_02_02_EVS_NEURON_BRIDGE_Port_CTL | access | 101 | - | - | - |
| Ethernet19 | MIC_RX_37C02_01_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet20 | MIC_RX_37C02_02_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet21 | MIC_RX_37C02_03_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet22 | MIC_RX_37C02_04_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet23 | MIC_RX_37C02_05_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet24 | MIC_RX_37C02_06_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet25 | MIC_RX_37C02_07_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet26 | MIC_RX_37C02_08_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet27 | MIC_RX_37C02_09_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet28 | MIC_RX_37C02_10_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet29 | MIC_RX_37C02_11_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet30 | MIC_RX_37C02_12_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet31 | MIC_RX_37C02_13_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet32 | MIC_RX_37C02_14_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet33 | MIC_RX_37C02_15_SHURE_ANX4_Port_DANTE | access | 302 | - | - | - |
| Ethernet34 | ANLZ_37C03_01_SHURE_AD600_Port_DANTE_SEC | access | 302 | - | - | - |
| Ethernet35 | ANLZ_37C03_01_SHURE_AD600_Port_DANTE_PRI | access | 301 | - | - | - |
| Ethernet36 | ICM_MTX_37C05_01_05_RIEDEL_ARTIST_UIC_128_Port_Port2 | access | 262 | - | - | - |
| Ethernet41 | SPLIT_37C02_01_WISYCOM_SPL2216_Port_ENET | access | 204 | - | - | - |
| Ethernet42 | SPLIT_37C02_02_WISYCOM_SPL2216_Port_ENET | access | 204 | - | - | - |
| Ethernet43 | SPLIT_37C02_03_WISYCOM_SPL2216_Port_ENET | access | 204 | - | - | - |
| Ethernet44 | SPLIT_37C02_04_WISYCOM_SPL2216_Port_ENET | access | 204 | - | - | - |
| Ethernet47 | ANLZ_37C03_01_SHURE_AD600_Port_CTL2 | access | 100 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet4/4/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet4/4/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | *- | *- | 10 |
...
!
interface Ethernet1
   description MIC_RX_37C02_14_SHURE_ANX4_Port_CTRL_1
   no shutdown
...
!
interface Ethernet2
   description MIC_RX_37C02_15_SHURE_ANX4_Port_CTRL_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
...
interface Ethernet15
   description GWAY_37C02_01_01_EVS_NEURON_BRIDGE_Port_CTL
   no shutdown
...
interface Ethernet16
   description GWAY_37C02_01_02_EVS_NEURON_BRIDGE_Port_CTL
   no shutdown
   switchport access vlan 101
   switchport mode access
   switchport
...
interface Ethernet17
   description GWAY_37C02_02_01_EVS_NEURON_BRIDGE_Port_CTL
   no shutdown
   switchport access vlan 101
   switchport mode access
   switchport
...
interface Ethernet18
   description GWAY_37C02_02_02_EVS_NEURON_BRIDGE_Port_CTL
   no shutdown
   switchport access vlan 101
   switchport mode access
   switchport
...
interface Ethernet34
   description ANLZ_37C03_01_SHURE_AD600_Port_DANTE_SEC
   no shutdown
   switchport access vlan 302
   switchport mode access
   switchport
...
interface Ethernet35
   description ANLZ_37C03_01_SHURE_AD600_Port_DANTE_PRI
   no shutdown
...
interface Ethernet36
   description ICM_MTX_37C05_01_05_RIEDEL_ARTIST_UIC_128_Port_Port2
   no shutdown
...
interface Ethernet41
   description SPLIT_37C02_01_WISYCOM_SPL2216_Port_ENET
   no shutdown
...
interface Ethernet42
   description SPLIT_37C02_02_WISYCOM_SPL2216_Port_ENET
   no shutdown
   switchport access vlan 204
   switchport mode access
   switchport
...
interface Ethernet43
   description SPLIT_37C02_03_WISYCOM_SPL2216_Port_ENET
   no shutdown
   switchport access vlan 204
   switchport mode access
   switchport
...
interface Ethernet44
   description SPLIT_37C02_04_WISYCOM_SPL2216_Port_ENET
   no shutdown
   switchport access vlan 204
   switchport mode access
   switchport
...
interface Ethernet47
   description ANLZ_37C03_01_SHURE_AD600_Port_CTL2
   no shutdown
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet4/4/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet4/4/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel44 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | - | - | - | - | - | - |
...
interface Port-Channel10
   description L2_SPINES_Port-Channel44
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.44/24  |  -  |  -  |  -  |  -  |
