...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | TBD | TBD |
...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| - | 10.93.240.74 | 30 | 104 | 8 | 100 | boundary | - |
...
ip route vrf MGMT 0.0.0.0/0 TBD
```
