...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.136.116/28 | 10.176.136.113 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | GPLB_SPK92_EDC_ACOUSTICS_SS_3_Port_RJ45 | access | 305 | - | - | - |
| Ethernet2 | GPLB_SKP86A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet3 | GPLB_SKP87A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet4 | GPLB_SKP88A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet5 | GPLB_SKP89A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet6 | GPLB_SKP90A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 305 | - | - | - |
| Ethernet11 | 02C_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 303 | - | - | - |
| Ethernet21 | 02C_APROC_A_QSC_Core_8_Flex_Port_RJ45 | access | 304 | - | - | - |
| Ethernet25 | GPLB_SPK92_EDC_ACOUSTICS_SS_3_Port_RJ45 | access | 100 | - | - | - |
| Ethernet26 | 02C_SPK07_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet27 | 02C_SPK12_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet28 | 02C_SPK11_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet29 | 02C_SPK16_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet30 | 02C_SPK15_Signal_Transport_M621_Port_RJ45 | access | 100 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet6/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet6/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | *- | *- | 10 |
...
!
interface Ethernet1
   description GPLB_SPK92_EDC_ACOUSTICS_SS_3_Port_RJ45
   no shutdown
...
!
interface Ethernet2
   description GPLB_SKP86A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet3
   description GPLB_SKP87A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet4
   description GPLB_SKP88A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet5
   description GPLB_SKP89A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet6
   description GPLB_SKP90A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet11
   description 02C_APROC_A_QSC_Core_8_Flex_Port_RJ45
   no shutdown
...
interface Ethernet26
   description 02C_SPK07_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet27
   description 02C_SPK12_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet28
   description 02C_SPK11_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet29
   description 02C_SPK16_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet30
   description 02C_SPK15_Signal_Transport_M621_Port_RJ45
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet6/23/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet6/23/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel74 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1000 | - | - | - | - | - | - |
...
interface Port-Channel10
   description L2_SPINES_Port-Channel74
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.74/24  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.176.136.113 | - | 1 | - | - | - |
...
ip route vrf MGMT 0.0.0.0/0 10.176.136.113
```
