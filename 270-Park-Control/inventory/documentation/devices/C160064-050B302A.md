...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.143.67/28 | 10.176.143.65 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet25 | PLT_50PRQ_001_NEUTRIK_NE8FDX_Y6_W_Port_1 | access | 100 | - | - | - |
| Ethernet26 | PLT_50PRQ_001_NEUTRIK_NE8FDX_Y6_W_Port_2 | access | 100 | - | - | - |
| Ethernet27 | PLT_50PRQ_002_NEUTRIK_NE8FDX_Y6_W_Port_1 | access | 100 | - | - | - |
| Ethernet28 | PLT_50PRQ_002_NEUTRIK_NE8FDX_Y6_W_Port_2 | access | 100 | - | - | - |
| Ethernet29 | MAP_50TRB_001_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet30 | MAP_50TRB_003_SHURE_AD610_Port_1 | access | 108 | - | - | - |
| Ethernet31 | ICOM_50TRB_003_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1 | access | 261 | - | - | - |
| Ethernet32 | ICOM_50TRB_009_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1 | access | 108 | - | - | - |
| Ethernet33 | ICOM_50TRB_001_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1 | access | 261 | - | - | - |
| Ethernet34 | ICOM_50TRB_002_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1 | access | 261 | - | - | - |
| Ethernet38 | AMP_50PRQ_001_QSC_CX_Q_4K4_Port_1 | access | 339 | - | - | - |
| Ethernet39 | DSP_50PRQ_001_QSC_Core_8_Flex_Port_1 | access | 339 | - | - | - |
| Ethernet49 | PLT_50PRQ_001_NEUTRIK_NO4FDW_A_Port_2 | access | 132 | - | - | - |
| Ethernet50 | PLT_50PRQ_001_NEUTRIK_NO4FDW_A_Port_4 | access | 132 | - | - | - |
| Ethernet51 | PLT_50PRQ_002_NEUTRIK_NO4FDW_A_Port_2 | access | 132 | - | - | - |
| Ethernet52 | PLT_50PRQ_002_NEUTRIK_NO4FDW_A_Port_4 | access | 132 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet3/10/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet3/10/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
interface Ethernet25
   description PLT_50PRQ_001_NEUTRIK_NE8FDX_Y6_W_Port_1
   no shutdown
...
interface Ethernet26
   description PLT_50PRQ_001_NEUTRIK_NE8FDX_Y6_W_Port_2
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet27
   description PLT_50PRQ_002_NEUTRIK_NE8FDX_Y6_W_Port_1
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet28
   description PLT_50PRQ_002_NEUTRIK_NE8FDX_Y6_W_Port_2
   no shutdown
   switchport access vlan 100
   switchport mode access
   switchport
...
interface Ethernet29
   description MAP_50TRB_001_SHURE_AD610_Port_1
   no shutdown
...
interface Ethernet30
   description MAP_50TRB_003_SHURE_AD610_Port_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
...
interface Ethernet31
   description ICOM_50TRB_003_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1
   no shutdown
...
interface Ethernet32
   description ICOM_50TRB_009_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1
   no shutdown
   switchport access vlan 108
   switchport mode access
   switchport
...
interface Ethernet33
   description ICOM_50TRB_001_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1
   no shutdown
   switchport access vlan 261
   switchport mode access
   switchport
...
interface Ethernet34
   description ICOM_50TRB_002_RIEDEL_BL_ANT_1010_19G_US_G2_Port_1
   no shutdown
   switchport access vlan 261
   switchport mode access
   switchport
...
interface Ethernet38
   description AMP_50PRQ_001_QSC_CX_Q_4K4_Port_1
   no shutdown
...
interface Ethernet39
   description DSP_50PRQ_001_QSC_Core_8_Flex_Port_1
   no shutdown
   switchport access vlan 339
   switchport mode access
   switchport
...
interface Ethernet49
   description PLT_50PRQ_001_NEUTRIK_NO4FDW_A_Port_2
   no shutdown
...
interface Ethernet50
   description PLT_50PRQ_001_NEUTRIK_NO4FDW_A_Port_4
   no shutdown
   switchport access vlan 132
   switchport mode access
   switchport
...
interface Ethernet51
   description PLT_50PRQ_002_NEUTRIK_NO4FDW_A_Port_2
   no shutdown
   switchport access vlan 132
   switchport mode access
   switchport
...
interface Ethernet52
   description PLT_50PRQ_002_NEUTRIK_NO4FDW_A_Port_4
   no shutdown
   switchport access vlan 132
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet3/10/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet3/10/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel178 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.178/24  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.176.143.65 | - | 1 | - | - | - |
