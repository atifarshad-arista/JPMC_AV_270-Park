...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.176.136.115/28 | 10.176.136.113 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | 01UPL_SPK131_EDC_ACOUSTICS_SS_3_Port_RJ45 | access | 305 | - | - | - |
| Ethernet2 | 01UPL_SKP111A_EDC_ACOUSTICS_SC_60D_Port_RJ45 | access | 100 | - | - | - |
| Ethernet3 | 01UPL_SKP112A_EDC_ACOUSTICS_SC_60D_Port_Virt | access | 305 | - | - | - |
| Ethernet4 | 01UPL_SKP113A_EDC_ACOUSTICS_SC_60D_Port_Virt | access | 305 | - | - | - |
| Ethernet5 | 01UPL_SKP114A_EDC_ACOUSTICS_SC_60D_Port_Virt | access | 305 | - | - | - |
| Ethernet11 | 02A_APROC_A_QSC_Core_8_Flex_Port_Virt | access | 305 | - | - | - |
| Ethernet18 | 01UPL_ANT74_SHURE_AD610_Port_RJ45 | access | 305 | - | - | - |
| Ethernet21 | 02A_APROC_A_QSC_Core_8_Flex_Port_Virt | access | 305 | - | - | - |
| Ethernet25 | 01UPL_SPK131_EDC_ACOUSTICS_SS_3_Port_Virt | access | 305 | - | - | - |
| Ethernet26 | 02A_SPK04_Signal_Transport_M621_Port_Virt | access | 305 | - | - | - |
| Ethernet27 | 02A_SPK02_Signal_Transport_M621_Port_Virt | access | 305 | - | - | - |
| Ethernet28 | 02A_SPK06_Signal_Transport_M621_Port_Virt | access | 305 | - | - | - |
| Ethernet29 | 02A_SPK09_Signal_Transport_M621_Port_Virt | access | 305 | - | - | - |
| Ethernet53/1 | L2_C160064-037B300A_Ethernet8/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
| Ethernet54/1 | L2_C160064-037B301A_Ethernet8/23/1 | *trunk | *100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | *- | *- | 10 |
...
!
interface Ethernet1
   description 01UPL_SPK131_EDC_ACOUSTICS_SS_3_Port_RJ45
   no shutdown
...
!
interface Ethernet2
   description 01UPL_SKP111A_EDC_ACOUSTICS_SC_60D_Port_RJ45
   no shutdown
...
!
interface Ethernet3
   description 01UPL_SKP112A_EDC_ACOUSTICS_SC_60D_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet4
   description 01UPL_SKP113A_EDC_ACOUSTICS_SC_60D_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
!
interface Ethernet5
   description 01UPL_SKP114A_EDC_ACOUSTICS_SC_60D_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet11
   description 02A_APROC_A_QSC_Core_8_Flex_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet18
   description 01UPL_ANT74_SHURE_AD610_Port_RJ45
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet25
   description 01UPL_SPK131_EDC_ACOUSTICS_SS_3_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet26
   description 02A_SPK04_Signal_Transport_M621_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet27
   description 02A_SPK02_Signal_Transport_M621_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet28
   description 02A_SPK06_Signal_Transport_M621_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet29
   description 02A_SPK09_Signal_Transport_M621_Port_Virt
   no shutdown
   switchport access vlan 305
   switchport mode access
   switchport
...
interface Ethernet53/1
   description L2_C160064-037B300A_Ethernet8/23/1
   no shutdown
   channel-group 10 mode active
!
interface Ethernet54/1
   description L2_C160064-037B301A_Ethernet8/23/1
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | L2_SPINES_Port-Channel72 | trunk | 100-108,121,131-132,141-144,161-164,181,200-205,241-245,261-262,301-344,1001 | - | - | - | - | - | - |
...
interface Port-Channel10
   description L2_SPINES_Port-Channel72
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan200 |  default  |  10.93.240.72/24  |  -  |  -  |  -  |  -  |
