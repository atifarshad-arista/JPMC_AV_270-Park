...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/27/1 | - | 100.83.100.249/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/28/1 | - | 100.83.100.251/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/27/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.249/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/28/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.251/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.248 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.250 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.27
   ...
   neighbor 100.83.100.248 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.248 remote-as 65020.1
   neighbor 100.83.100.248 description red-spine1_Ethernet5/27/1
   neighbor 100.83.100.250 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.250 remote-as 65020.1
   neighbor 100.83.100.250 description red-spine1_Ethernet5/28/1
