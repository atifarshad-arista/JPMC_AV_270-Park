...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.64/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_red-spine1_Ethernet9/41/1 | - | 100.83.202.115/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_red-spine1_Ethernet8/39/1 | - | 100.83.202.113/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_red-spine1_Ethernet9/41/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.115/31
   ptp enable
...
interface Ethernet2/2
   description P2P_red-spine1_Ethernet8/39/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.113/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.202.112 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.202.114 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.27
   ...
   neighbor 100.83.202.112 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.112 remote-as 65210.37100
   neighbor 100.83.202.112 description red-spine1_Ethernet8/39/1
   neighbor 100.83.202.114 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.114 remote-as 65210.37100
   neighbor 100.83.202.114 description red-spine1_Ethernet9/41/1
