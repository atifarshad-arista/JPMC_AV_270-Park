...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.10/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet4/21/1 | - | 100.83.88.81/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet4/22/1 | - | 100.83.88.83/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet4/21/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.81/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet4/22/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.83/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.80 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.82 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.6
   ...
   neighbor 100.83.88.80 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.80 remote-as 65010.1
   neighbor 100.83.88.80 description blue-spine1_Ethernet4/21/1
   neighbor 100.83.88.82 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.82 remote-as 65010.1
   neighbor 100.83.88.82 description blue-spine1_Ethernet4/22/1
