...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.166.80.46/27 | 10.166.80.33 |
...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| - | 169.27.195.39 | 30 | 103 | 8 | 100 | boundary | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_blue-spine1_Ethernet7/8/1 | - | 100.83.100.203/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_blue-spine1_Ethernet6/9/1 | - | 100.83.100.201/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_blue-spine1_Ethernet7/8/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.203/31
   ptp enable
...
interface Ethernet2/2
   description P2P_blue-spine1_Ethernet6/9/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.201/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 169.27.195.39/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.200 | 65211.37200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.202 | 65211.37200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |

#### Router BGP Device Configuration

```eos
!
router bgp 65211.37204
   router-id 169.27.195.39
   update wait-install
   no bgp default ipv4-unicast
   maximum-paths 4 ecmp 4
   bgp asn notation asdot
   ...
   neighbor 100.83.100.200 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.200 remote-as 65211.37200
   neighbor 100.83.100.200 description blue-spine1_Ethernet6/9/1
   neighbor 100.83.100.202 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.202 remote-as 65211.37200
   neighbor 100.83.100.202 description blue-spine1_Ethernet7/8/1
