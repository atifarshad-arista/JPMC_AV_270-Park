...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/29/1 | - | 100.83.101.1/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/30/1 | - | 100.83.101.3/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/29/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.1/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/30/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.3/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.101.0 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.101.2 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.28
   ...
   neighbor 100.83.101.0 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.0 remote-as 65020.1
   neighbor 100.83.101.0 description red-spine1_Ethernet5/29/1
   neighbor 100.83.101.2 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.2 remote-as 65020.1
   neighbor 100.83.101.2 description red-spine1_Ethernet5/30/1
