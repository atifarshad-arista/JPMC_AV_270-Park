...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.65/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_red-spine1_Ethernet9/43/1 | - | 100.83.202.139/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_red-spine1_Ethernet8/40/1 | - | 100.83.202.137/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_red-spine1_Ethernet9/43/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.139/31
   ptp enable
...
interface Ethernet2/2
   description P2P_red-spine1_Ethernet8/40/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.137/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 169.27.195.29/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.202.136 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.202.138 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.28
   ...
   neighbor 100.83.202.136 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.136 remote-as 65210.37100
   neighbor 100.83.202.136 description red-spine1_Ethernet8/40/1
   neighbor 100.83.202.138 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.138 remote-as 65210.37100
   neighbor 100.83.202.138 description red-spine1_Ethernet9/43/1
