...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.166.80.12/27 | 10.166.80.1 |
...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| - | 169.27.195.37 | 30 | 103 | 8 | 100 | boundary | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_blue-spine1_Ethernet6/7/1 | - | 100.83.100.193/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_blue-spine1_Ethernet7/7/1 | - | 100.83.100.197/31 | default | 1500 | False | - | - |
| Ethernet2/3 | P2P_blue-spine1_Ethernet6/8/1 | - | 100.83.100.195/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_blue-spine1_Ethernet6/7/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.193/31
   ptp enable
...
interface Ethernet2/2
   description P2P_blue-spine1_Ethernet7/7/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.197/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
interface Ethernet2/3
   description P2P_blue-spine1_Ethernet6/8/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.195/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 169.27.195.37/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.192 | 65211.37200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.194 | 65211.37200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.196 | 65211.37200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |

#### Router BGP Device Configuration

```eos
!
router bgp 65211.37203
   router-id 169.27.195.37
   update wait-install
   no bgp default ipv4-unicast
   maximum-paths 4 ecmp 4
   bgp asn notation asdot
   ...
   neighbor 100.83.100.192 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.192 remote-as 65211.37200
   neighbor 100.83.100.192 description blue-spine1_Ethernet6/7/1
   neighbor 100.83.100.194 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.194 remote-as 65211.37200
   neighbor 100.83.100.194 description blue-spine1_Ethernet6/8/1
   neighbor 100.83.100.196 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.196 remote-as 65211.37200
   neighbor 100.83.100.196 description blue-spine1_Ethernet7/7/1
