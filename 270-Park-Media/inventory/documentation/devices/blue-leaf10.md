...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.14/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet4/29/1 | - | 100.83.88.113/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet4/30/1 | - | 100.83.88.115/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet4/29/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.113/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet4/30/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.115/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.112 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.114 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.10
   ...
   neighbor 100.83.88.112 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.112 remote-as 65010.1
   neighbor 100.83.88.112 description blue-spine1_Ethernet4/29/1
   neighbor 100.83.88.114 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.114 remote-as 65010.1
   neighbor 100.83.88.114 description blue-spine1_Ethernet4/30/1
