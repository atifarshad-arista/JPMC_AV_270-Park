...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.17/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet4/35/1 | - | 100.83.88.137/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet4/36/1 | - | 100.83.88.139/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet4/35/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.137/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet4/36/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.139/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 169.27.195.19/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.136 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.138 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.13
   ...
   neighbor 100.83.88.136 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.136 remote-as 65010.1
   neighbor 100.83.88.136 description blue-spine1_Ethernet4/35/1
   neighbor 100.83.88.138 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.138 remote-as 65010.1
   neighbor 100.83.88.138 description blue-spine1_Ethernet4/36/1
