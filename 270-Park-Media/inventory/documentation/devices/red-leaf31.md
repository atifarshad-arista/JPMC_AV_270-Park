...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_red-spine1_Ethernet9/49/1 | - | 100.83.202.211/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_red-spine1_Ethernet8/43/1 | - | 100.83.202.209/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_red-spine1_Ethernet9/49/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.211/31
   ptp enable
...
interface Ethernet2/2
   description P2P_red-spine1_Ethernet8/43/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.202.209/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.202.208 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.202.210 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.31
   ...
   neighbor 100.83.202.208 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.208 remote-as 65210.37100
   neighbor 100.83.202.208 description red-spine1_Ethernet8/43/1
   neighbor 100.83.202.210 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.202.210 remote-as 65210.37100
   neighbor 100.83.202.210 description red-spine1_Ethernet9/49/1
