...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet4/35/1 | - | 100.83.100.137/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet4/36/1 | - | 100.83.100.139/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet4/35/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.137/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet4/36/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.139/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.136 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.138 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.13
   ...
   neighbor 100.83.100.136 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.136 remote-as 65020.1
   neighbor 100.83.100.136 description red-spine1_Ethernet4/35/1
   neighbor 100.83.100.138 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.138 remote-as 65020.1
   neighbor 100.83.100.138 description red-spine1_Ethernet4/36/1
