...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.56/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/11/1 | - | 100.83.100.185/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/12/1 | - | 100.83.100.187/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/11/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.185/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/12/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.187/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.184 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.186 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.19
   ...
   neighbor 100.83.100.184 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.184 remote-as 65020.1
   neighbor 100.83.100.184 description red-spine1_Ethernet5/11/1
   neighbor 100.83.100.186 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.186 remote-as 65020.1
   neighbor 100.83.100.186 description red-spine1_Ethernet5/12/1
