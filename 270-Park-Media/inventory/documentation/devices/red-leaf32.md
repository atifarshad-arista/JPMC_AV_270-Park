...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet6/1/1 | - | 100.83.101.33/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet6/2/1 | - | 100.83.101.35/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet6/1/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.33/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet6/2/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.35/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.101.32 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.101.34 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.32
   ...
   neighbor 100.83.101.32 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.32 remote-as 65020.1
   neighbor 100.83.101.32 description red-spine1_Ethernet6/1/1
   neighbor 100.83.101.34 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.34 remote-as 65020.1
   neighbor 100.83.101.34 description red-spine1_Ethernet6/2/1
