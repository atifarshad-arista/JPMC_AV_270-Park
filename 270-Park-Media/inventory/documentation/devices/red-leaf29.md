...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/31/1 | - | 100.83.101.9/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/32/1 | - | 100.83.101.11/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/31/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.9/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/32/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.101.11/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.101.8 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.101.10 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.29
   ...
   neighbor 100.83.101.8 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.8 remote-as 65020.1
   neighbor 100.83.101.8 description red-spine1_Ethernet5/31/1
   neighbor 100.83.101.10 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.101.10 remote-as 65020.1
   neighbor 100.83.101.10 description red-spine1_Ethernet5/32/1
