...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_amber-spine1_Ethernet6 | - | 10.255.253.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_blue-spine1_Ethernet6 | - | 10.255.253.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_amber-spine1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_blue-spine1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.253.4 | 65100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 10.255.253.6 | 65200 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65400
   ...
   neighbor 10.255.253.4 peer group P2P-IPv4-eBGP-PEERS
   neighbor 10.255.253.4 remote-as 65100
   neighbor 10.255.253.4 description amber-spine1_Ethernet6
   neighbor 10.255.253.6 peer group P2P-IPv4-eBGP-PEERS
