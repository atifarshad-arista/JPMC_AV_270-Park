...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.55/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_red-spine1_Ethernet9/23/1 | - | 100.83.201.155/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_red-spine1_Ethernet8/30/1 | - | 100.83.201.153/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_red-spine1_Ethernet9/23/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.201.155/31
   ptp enable
...
interface Ethernet2/2
   description P2P_red-spine1_Ethernet8/30/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.201.153/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.201.152 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.201.154 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.18
   ...
   neighbor 100.83.201.152 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.201.152 remote-as 65210.37100
   neighbor 100.83.201.152 description red-spine1_Ethernet8/30/1
   neighbor 100.83.201.154 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.201.154 remote-as 65210.37100
   neighbor 100.83.201.154 description red-spine1_Ethernet9/23/1
