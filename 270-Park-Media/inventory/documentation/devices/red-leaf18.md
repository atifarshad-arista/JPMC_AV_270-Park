...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/9/1 | - | 100.83.100.177/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/10/1 | - | 100.83.100.179/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/9/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.177/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/10/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.179/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.176 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.178 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.18
   ...
   neighbor 100.83.100.176 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.176 remote-as 65020.1
   neighbor 100.83.100.176 description red-spine1_Ethernet5/9/1
   neighbor 100.83.100.178 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.178 remote-as 65020.1
   neighbor 100.83.100.178 description red-spine1_Ethernet5/10/1
