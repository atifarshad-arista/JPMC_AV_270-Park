...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.19/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet5/3/1 | - | 100.83.88.153/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet5/4/1 | - | 100.83.88.155/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet5/3/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.153/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet5/4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.155/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.152 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.154 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.15
   ...
   neighbor 100.83.88.152 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.152 remote-as 65010.1
   neighbor 100.83.88.152 description blue-spine1_Ethernet5/3/1
   neighbor 100.83.88.154 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.154 remote-as 65010.1
   neighbor 100.83.88.154 description blue-spine1_Ethernet5/4/1
