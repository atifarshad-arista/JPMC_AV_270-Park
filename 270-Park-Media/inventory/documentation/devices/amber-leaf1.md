...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Ethernet0 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.111/24 | 172.16.1.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_amber-spine1_Ethernet1 | - | 10.255.254.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_amber-spine1_Ethernet2 | - | 10.255.254.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_amber-spine1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_amber-spine1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
