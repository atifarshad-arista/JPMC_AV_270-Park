...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.15/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet4/31/1 | - | 100.83.88.121/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet4/32/1 | - | 100.83.88.123/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet4/31/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.121/31
   ptp enable
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.120 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.122 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.11
   ...
   neighbor 100.83.88.120 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.120 remote-as 65010.1
   neighbor 100.83.88.120 description blue-spine1_Ethernet4/31/1
   neighbor 100.83.88.122 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.122 remote-as 65010.1
   neighbor 100.83.88.122 description blue-spine1_Ethernet4/32/1
