...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.52/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | P2P_red-spine1_Ethernet7/23/1 | - | 100.83.201.83/31 | default | 1500 | False | - | - |
| Ethernet2/2 | P2P_red-spine1_Ethernet6/29/1 | - | 100.83.201.81/31 | default | 1500 | False | - | - |
...
interface Ethernet2/1
   description P2P_red-spine1_Ethernet7/23/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.201.83/31
   ptp enable
...
interface Ethernet2/2
   description P2P_red-spine1_Ethernet6/29/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.201.81/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.201.80 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.201.82 | 65210.37100 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.15
   ...
   neighbor 100.83.201.80 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.201.80 remote-as 65210.37100
   neighbor 100.83.201.80 description red-spine1_Ethernet6/29/1
   neighbor 100.83.201.82 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.201.82 remote-as 65210.37100
   neighbor 100.83.201.82 description red-spine1_Ethernet7/23/1
