...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet4/25/1 | - | 100.83.100.97/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet4/26/1 | - | 100.83.100.99/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet4/25/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.97/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet4/26/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.99/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.96 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.98 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.8
   ...
   neighbor 100.83.100.96 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.96 remote-as 65020.1
   neighbor 100.83.100.96 description red-spine1_Ethernet4/25/1
   neighbor 100.83.100.98 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.98 remote-as 65020.1
   neighbor 100.83.100.98 description red-spine1_Ethernet4/26/1
