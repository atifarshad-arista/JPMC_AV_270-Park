...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.27/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet5/19/1 | - | 100.83.88.217/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet5/20/1 | - | 100.83.88.219/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet5/19/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.217/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet5/20/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.219/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.216 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.218 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.23
   ...
   neighbor 100.83.88.216 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.216 remote-as 65010.1
   neighbor 100.83.88.216 description blue-spine1_Ethernet5/19/1
   neighbor 100.83.88.218 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.218 remote-as 65010.1
   neighbor 100.83.88.218 description blue-spine1_Ethernet5/20/1
