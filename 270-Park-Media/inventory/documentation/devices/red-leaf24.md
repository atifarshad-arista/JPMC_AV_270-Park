...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.61/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_red-spine1_Ethernet5/21/1 | - | 100.83.100.225/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_red-spine1_Ethernet5/22/1 | - | 100.83.100.227/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_red-spine1_Ethernet5/21/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.225/31
   ptp enable
...
interface Ethernet50/1
   description P2P_red-spine1_Ethernet5/22/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.100.227/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.100.224 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.100.226 | 65020.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65021.24
   ...
   neighbor 100.83.100.224 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.224 remote-as 65020.1
   neighbor 100.83.100.224 description red-spine1_Ethernet5/21/1
   neighbor 100.83.100.226 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.100.226 remote-as 65020.1
   neighbor 100.83.100.226 description red-spine1_Ethernet5/22/1
