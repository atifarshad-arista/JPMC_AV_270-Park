...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.100.100.21/24 | 10.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_blue-spine1_Ethernet5/7/1 | - | 100.83.88.169/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_blue-spine1_Ethernet5/8/1 | - | 100.83.88.171/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_blue-spine1_Ethernet5/7/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.169/31
   ptp enable
...
interface Ethernet50/1
   description P2P_blue-spine1_Ethernet5/8/1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.83.88.171/31
   ptp enable
   ptp announce interval 0
   ptp announce timeout 3
   ptp delay-req interval -3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 169.27.195.23/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 100.83.88.168 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
| 100.83.88.170 | 65010.1 | default | - | Inherited from peer group P2P-IPv4-eBGP-PEERS | Inherited from peer group P2P-IPv4-eBGP-PEERS | - | - | - | - | - | - |
...
router bgp 65011.17
   ...
   neighbor 100.83.88.168 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.168 remote-as 65010.1
   neighbor 100.83.88.168 description blue-spine1_Ethernet5/7/1
   neighbor 100.83.88.170 peer group P2P-IPv4-eBGP-PEERS
   neighbor 100.83.88.170 remote-as 65010.1
   neighbor 100.83.88.170 description blue-spine1_Ethernet5/8/1
